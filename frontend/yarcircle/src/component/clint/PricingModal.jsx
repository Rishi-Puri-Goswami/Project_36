        ...
        <div className="sticky top-0 bg-gradient-to-r from-blue-500 to-indigo-600 text-white p-6 rounded-t-2xl">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="mt-2 text-blue-100">Select a plan to view worker profiles</p>
            </div>
            <button
              onClick={onClose}
                  ...
                  >
                    {isPopular && (
                      <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                        <span className="bg-gradient-to-r from-blue-500 to-indigo-500 text-white px-4 py-1 rounded-full text-sm font-semibold shadow-lg">
                          ⭐ Most Popular
                        </span>
                      </div>
                    )}
                    ...
                    <div className="text-center">
                      ...
                      <button
                        ...
                        className={`w-full py-3 rounded-lg font-semibold transition-all disabled:opacity-50 disabled:cursor-not-allowed ${
                          isPopular
                            ? 'bg-gradient-to-r from-blue-500 to-indigo-500 text-white hover:from-blue-600 hover:to-indigo-600 shadow-lg shadow-blue-500/50'
          ...
          <div className="mt-8 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-6 border border-blue-200">
            <div className="text-center">
              ...
              <div className="flex flex-wrap items-center justify-center gap-4">
                {/* UPI Payment Badge */}
                <div className="bg-white px-4 py-2 rounded-lg shadow-sm border border-blue-300">
                  <span className="text-sm font-semibold text-blue-600">📱 UPI / QR Code</span>
                </div>
                ...
                <div className="bg-white px-4 py-2 rounded-lg shadow-sm">
                  <span className="text-sm font-semibold text-gray-700">👛 Wallets</span>
                </div>
              </div>
